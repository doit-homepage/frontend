...
const Signup = () => {
  ...
  var student_num_check = () => {
    axios
      .post("/api/user/checkNumber", { student_num: state["student_num"] })
      .then((res) => {
        if (res.data.success == true) {
    ...
    <div className="Signup">
      <center>
        <div className="Signup_input_div_total">
          ...
          <form
            className="Signup_input_form"
            action={url + "user"}
            method="POST"
            onSubmit={submit_check}
          >
            <div className="Signup_input_div">
              아이디{" "}
              <button className="Signup_button" onClick={id_check}>
                중복확인
              </button>
              <br />
              <input
            ...
            <div className="Signup_input_div">
              학번{" "}
              <button className="Signup_button" onClick={student_num_check}>
                중복확인
              </button>
              <br />
              <input
            ...
            <div className="Signup_input_div">
              이메일{" "}
              <button className="Signup_button" onClick={mailauth}>
                인증코드 받기
              </button>
              <br />
              <input
            ...
            <div className="Signup_input_div">
              이메일 인증 코드{" "}
              <button className="Signup_button" onClick={mailauthCheck}>
                코드 확인
              </button>
              <br />
              <input
